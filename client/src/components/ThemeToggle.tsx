 ...
 *   возврат к нему — через настройки.
 *
 * ОГРАНИЧЕНИЯ:
...
export function ThemeToggle() {
  ...
  const handleClick = () => {
    // Клик переключает на явный противоположный выбор. Режим «как в
    // системе» остаётся в store до явного возврата через настройки.
    setColorMode(isDark ? 'light' : 'dark');
  };

  // data-testid — для теста: тест смотрит на aria-pressed и текущий
