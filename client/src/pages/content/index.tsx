...
export default function ContentPage() {
  ...
  const [aiModel, setAiModel] = useState<'gemini-3.5-flash' | 'gemini-2.5-flash' | 'gemini-2.5-pro' | 'deepseek' | 'qwen'>('gemini-3.5-flash');
                          ...
                          return (
                            <div key={keyword.id || keyword.keyword} className="flex items-center space-x-1">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  console.log('Checkbox changed:', keyword.keyword, checked);
