 ...
 * проход должен быть debug, ненулевой результат — info, failure — error.
 *
 ...
 *  - cron.failed / token_reset_failed уйдут с error на info (B2).
 *
 * Проверяется по исходнику — уровень лога это статическая константа/тернар.
 */
