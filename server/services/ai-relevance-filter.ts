...
- Канал релевантен, если его тематика связана с ключевыми словами
- Канал НЕ релевантен, если он完全无关 (например, юмор/новости при поиске SMM-инструментов)
- Не удаляй каналы仅 потому что они niche — лучше оставить релевантные нишевые
