...
// Пример из проблемы пользователя
const userProblemText = `
<b>Если не получится, оторву голову!
<i>Буду тестить
<u>Пока не получится
<s>Иначе
<b>Хана Реплиту
...
<b>Жирный <i>текст с <u>вложенным подчеркиванием</u></i></b>
<b>и курсивом. Этот тег жирного шрифта</b>

<b>Второй жирный текст с <i>курсивом</i></b>
<code>Моноширинный текст</code>

Внешняя конструкция <b>где внутри есть <i>курсив</i></b>
`;
...
async function runTest() {
  ...
  await sendToTelegram(userProblemText, 'Пример из проблемы пользователя');
