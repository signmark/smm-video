...
const KEYS_NEEDED = ['ANTHROPIC_API_KEY', 'GEMINI_API_KEY', 'GOOGLE_API_KEY', 'GOOGLE_AI_API_KEY', 'HUGGINGFACE_API_KEY', 'FAL_AI_API_KEY', 'OPENAI_API_KEY', 'DEEPSEEK_API_KEY', 'GEMINI_PROXY_URL', 'BEGET_S3_ACCESS_KEY', 'BEGET_S3_SECRET_KEY', 'BEGET_S3_BUCKET', 'BEGET_S3_ENDPOINT', 'BEGET_S3_REGION', 'PEXELS_API_KEY', 'PIXABAY_API_KEY', 'JAMENDO_CLIENT_ID'];
